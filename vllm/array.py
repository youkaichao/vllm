...
numba_initialize_array = numba_initialize_array.compile(
    (numba_dtype, numba_dtype))
...
numba_get_num_empty_slots = numba_get_num_empty_slots.compile(
    (types.Array(numba_dtype, 1, 'C'), ))
...
numba_extend = numba_extend.compile(
...
numba_append = numba_append.compile((types.Array(numba_dtype, 1,
                                                 'C'), numba_dtype))
...
numba_get_item = numba_get_item.compile((types.Array(numba_dtype, 1,
                                                     'C'), numba_dtype))
...
numba_set_item = numba_set_item.compile(
    (types.Array(numba_dtype, 1, 'C'), numba_dtype, numba_dtype))
...
numba_get_meta_item = numba_get_meta_item.compile(
    (types.Array(numba_dtype, 1, 'C'), numba_dtype))
...
numba_set_meta_item = numba_set_meta_item.compile(
    (types.Array(numba_dtype, 1, 'C'), numba_dtype, numba_dtype))
